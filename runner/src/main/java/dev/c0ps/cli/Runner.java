...
import dev.c0ps.cli.utils.ArgsParser;
import dev.c0ps.cli.utils.ReflectionUtils;
...
public class Runner {
    ...
    public Runner(String basePkg) {
        this(basePkg, new NoLogSettings());
    }

    public Runner(String basePkg, ILogSettings logSettings) {
